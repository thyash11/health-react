    ...
    <div className="space-y-6 pb-12">
      ...
      <section className="rounded-2xl border border-slate-200/80 bg-white p-4 shadow-sm sm:p-5">
        <button
          ...
          aria-controls="food-log-json-content"
          className="flex w-full items-center justify-between gap-3 text-left"
        >
          <h3 className="text-sm font-bold text-slate-900">Import Food Log JSON</h3>
          <ChevronDown className={`h-4 w-4 shrink-0 text-slate-500 transition-transform ${showJsonImport ? "rotate-180" : ""}`} />
        </button>

        {showJsonImport && (
        <div id="food-log-json-content" className="mt-4 space-y-4">
